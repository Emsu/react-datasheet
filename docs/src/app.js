    ...
    return (
      <div>
        <div className={'header'}>
          ...
          <a className={'github-link'} href='https://github.com/nadbm/react-datasheet'><span className='hidden-xs'> View on GitHub </span><span className='octicon octicon-mark-github' aria-hidden='true' /></a>
        </div>
